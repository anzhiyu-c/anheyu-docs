      ...
      <section className="flex flex-col items-center gap-12 md:flex-row md:gap-16">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="mt-4 text-3xl font-bold tracking-tight text-slate-800 dark:text-slate-100 sm:text-4xl">
            一个简洁、快速、高效的
            <span className="block mt-1 text-4xl font-extrabold text-black dark:text-white sm:text-5xl">内容应用</span>
          </p>
          <p className="max-w-xl mx-auto mt-6 text-lg text-slate-600 dark:text-slate-400 md:mx-0">生活明朗，万物可爱</p>
